...
let package = Package(
    ...
    products: [
        ...
        .library(
            name: "TuneSearchInfrastructure",
            targets: ["TuneSearchInfrastructure"]),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .target(
            name: "TuneSearchInfrastructure",
            dependencies: ["Alamofire","TunesearchCorePorts"]),
        .testTarget(
            name: "TuneSearchInfrastructureTests",
            dependencies: ["TuneSearchInfrastructure"]),
    ]
)
